...
//
//	mockgen -source=internal/club/domain/repository.go -destination=internal/club/mock/repository_mock.go -package=mock
//
...
func (m *MockTeamRepository) ExistsByName(ctx context.Context, name, excludeID string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTeamRepositoryMockRecorder) ExistsByName(ctx, name, excludeID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExistsByName", reflect.TypeOf((*MockTeamRepository)(nil).ExistsByName), ctx, name, excludeID)
}
